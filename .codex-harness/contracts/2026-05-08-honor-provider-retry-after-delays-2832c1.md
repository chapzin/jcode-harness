...
Honor provider Retry-After delay hints in retry sleeps before falling back to shared jittered backoff.
</untrusted-data>
...
cargo test -p jcode provider_retry_delay --lib -- --test-threads=1 --nocapture
</untrusted-data>
...
Follow-up to shared Retry-After parsing and jitter slices for issue #27. Keep scope to retry delay selection, not global limiter architecture.
</untrusted-data>
