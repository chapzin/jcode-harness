...
Replace fixed provider retry sleeps with a shared capped exponential full-jitter backoff helper for initial provider paths.
</untrusted-data>
...
cargo test -p jcode provider_retry_backoff --lib -- --test-threads=1 --nocapture
</untrusted-data>
...
Third issue #27 implementation slice. Keep small and avoid changing retry counts or broad limiter architecture.
</untrusted-data>
